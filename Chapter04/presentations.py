...
response = client.images.generate(
    model='dall-e-3',
    prompt=f'이 회사의 설명인 {company_summary}을 바탕으로, 꽃말의 비밀정원 회사가 함께 성장하고 전진하는 영감을 주는 이미지를 만들어 주세요. 이 이미지는 분기별 판매 계획 회의에서 사용될 것입니다.',
    size='1024x1024',
    quality='hd',
    n=1
)
...
with open("꽃말의비밀정원.pptx", "wb") as f:
